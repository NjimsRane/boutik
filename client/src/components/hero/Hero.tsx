...
const Hero = () => {
  return (
    <div className="py-8 grid grid-cols-1 lg:grid-cols-3 gap-8 hero lg:h-[100vh] mt-8 ">
      <div className="bg-cover bg-center h-[32rem] lg:h-[89vh] w-full flex flex-col justify-center gap-6 lg:gap-10 p-8 hero1"
         style={{
