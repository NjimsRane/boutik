...
import {appStore , playStore ,mastercard ,ae ,visa , visaElectron ,payPal,twitter ,instagram , facebook,youtube} from '../../assets'
    ...
    <footer className="bg-[#212B36] py-4">
      ...
      <div className="px-16 md:px-20 lg:px-36 py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
        <div className="flex flex-col flex-1 gap-6">
          <Link to='/'>
              <img src={logo2} alt="logo"  className='w-44'/>
          </Link>
          <div className="flex items-center gap-4">
              <AiOutlineHome size={25} color='#3056D3' />
              <p className="text-xl text-[#637381] font-semibold">Shop 009A ,Level 4, wp A, <br /> Demo Park,Yaounde</p>
          </div>
          <div className="flex items-center gap-4">
            <AiOutlinePhone size={25} color='#3056D3'/>
            <p className="text-xl text-[#637381] font-semibold">+237-613-555-0182</p>
          </div>
          <div className="flex items-center gap-4">
            <AiOutlineMail size={25} color='#3056D3'/>
            <p className="text-xl text-[#637381] font-semibold">contact@yourmail.com</p>
          </div>
        </div>
        ...
        <div className="flex-1" >
           ...
           <div className="grid grid-cols-1 gap-8">
              <span className="block h-[5rem]">
                <a href="#" aria-label="link to app store">
                  <img src={appStore} alt="link" className="rounded w-fit h-full object-cover"/>
                </a>
              </span>
              <span className="block h-[5rem]">
                <a href="#" aria-label="link to play store">
                  <img src={playStore} alt="link" className="rounded w-fit h-full object-cover" />
                </a>
              </span>
           </div>
        </div>
     ...
     <hr className="border border-[#637381] w-full" />
      <div className="px-16 md:px-20 lg:px-36 ">
        ...
        <p className="text-lg text-center text-[#637381]">Copyright &copy; <span>{new Date().getFullYear()}</span> Done by NjimsRane with <span className="text-[crimson]">&hearts;</span>
        </p>
